        ...
        <div className="bg-white rounded-xl shadow-2xl border border-blue-100 p-6 relative z-20">
          <form onSubmit={handleSearch} className="space-y-4">
            ...
            <div className="flex flex-col md:flex-row items-stretch md:items-center gap-4">
              ...
              <button 
                type="submit"
                className="w-full md:w-auto h-14 bg-blue-700 text-white px-8 rounded-lg hover:bg-blue-800 active:bg-blue-900 transition-all duration-200 font-medium shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
