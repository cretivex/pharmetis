...
const base =
  'inline-flex items-center justify-center gap-2 rounded-xl font-semibold transition duration-200 ease-out motion-safe:active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50'

const variants = {
  primary:
    'bg-brand text-white shadow-lg shadow-black/25 ring-1 ring-white/10 hover:bg-brand-hover hover:shadow-black/30',
  secondary:
  ...
  headerPrimary:
    '!rounded-full bg-brand text-white shadow-[0_0_18px_rgba(0,0,0,0.35)] ring-0 hover:bg-brand-hover hover:shadow-[0_0_22px_rgba(0,0,0,0.45)] !font-medium',
}
