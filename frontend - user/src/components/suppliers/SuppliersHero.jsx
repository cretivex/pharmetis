...
import { suppliersQuickFilters } from '../../data/suppliersCatalog'
export default function SuppliersHero({
  searchQuery,
  onSearchChange,
  onSearchSubmit,
  onQuickFilter,
  quickFilters = suppliersQuickFilters,
}) {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-[#071228] to-[#1e1045] pb-16 pt-10 text-white md:pb-20 md:pt-12">
      <div
        ...
        <div className="relative flex justify-center lg:justify-end">
          <div className="relative w-full max-w-lg">
            ...
            <div className="relative overflow-hidden rounded-2xl ring-2 ring-white/25 shadow-2xl">
              <img
                src="/suppliers-hero-pharma.png"
                alt="Pharmaceutical manufacturing and certified suppliers"
                width={640}
                height={480}
