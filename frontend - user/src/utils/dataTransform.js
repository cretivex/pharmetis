...
export const transformSupplier = (supplier) => {
  ...
  const apiCompliance = supplier.compliance || {}
  ...
  return {
    ...
    image: supplier.logo || supplier.logo_url || null,
    isVerified: supplier.isVerified || false,
    description: supplier.description,
    email: supplier.user?.email || supplier.email || null,
    phone: supplier.phone,
    website: supplier.website,
    therapeutics: supplier.therapeutics || null,
    manufacturerLabel: supplier.manufacturer || null,
    ...
    compliance: {
      whoGmp: Boolean(apiCompliance.whoGmp || hasWhoGmp),
      fda: Boolean(apiCompliance.fda || hasFda),
      iso: Boolean(apiCompliance.iso || hasIso),
      dmf: Boolean(apiCompliance.dmf),
      coa: Boolean(apiCompliance.coa),
      auditTrail: Boolean(apiCompliance.auditTrail),
    },
    capability: {
...
export const transformProductDetail = (product) => {
  ...
  const manufacturer = {
    ...
    city: supplier.city || product.city || null,
    phone: supplier.phone || product.supplierPhone || null,
    yearsInBusiness: supplier.yearsInBusiness || 0,
    totalProducts: supplier._count?.products || 0,
