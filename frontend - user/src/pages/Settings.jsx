...
function Settings() {
  ...
  const handleDocumentUpload = (e) => {
    ...
    setCompanyInfo({
      ...companyInfo,
      documents: [...(companyInfo.documents || []), ...newDocuments]
    });
  };
                  ...
                  <div>
                    ...
                    <div className="max-w-xl space-y-8">
                      ...
                      <div className="flex items-center gap-5">
                        ...
                        <div>
                          <label className="inline-flex items-center gap-2 text-sm font-medium text-primary hover:text-blue-700 cursor-pointer transition-colors">
                      ...
                      <div className="flex justify-end pt-8">
                        <button
                          ...
                          disabled={saving}
                          className="h-11 px-6 rounded-lg bg-primary text-white text-sm font-medium shadow-[0_4px_14px_rgba(59,130,246,0.25)] hover:shadow-[0_6px_20px_rgba(59,130,246,0.35)] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                        >
                          {saving ? (
                    ...
                    <div className="max-w-xl space-y-8">
                      ...
                      <div className="mt-12 flex justify-end">
                        <button
                          ...
                          disabled={saving}
                          className="h-11 px-6 rounded-lg bg-primary text-white text-sm font-medium shadow-[0_4px_14px_rgba(59,130,246,0.25)] hover:shadow-[0_6px_20px_rgba(59,130,246,0.35)] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:shadow-none flex items-center gap-2"
                        >
                          {saving ? (
                            <>
                  ...
                  <div>
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <button
                        ...
                        className="h-11 px-4 rounded-lg text-sm font-medium bg-primary text-white hover:bg-blue-600 shadow-[0_4px_14px_rgba(59,130,246,0.25)] hover:shadow-[0_6px_20px_rgba(59,130,246,0.35)] transition-all duration-200 flex items-center gap-2 shrink-0"
                      >
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="flex justify-end pt-2">
                            <button
                              ...
                              disabled={saving}
                              className="h-11 px-6 rounded-lg bg-primary text-white text-sm font-medium shadow-[0_4px_14px_rgba(59,130,246,0.25)] hover:shadow-[0_6px_20px_rgba(59,130,246,0.35)] transition-all duration-200 disabled:opacity-50 flex items-center gap-2"
                            >
                  ...
                  <div>
                    ...
                    <div className="space-y-10">
                      <div className="flex items-center justify-between py-5 border-b border-blue-200">
                        ...
                        <button type="button" className="h-11 px-4 rounded-lg text-sm font-medium bg-primary text-white hover:bg-blue-600 shadow-[0_4px_14px_rgba(59,130,246,0.25)] hover:shadow-[0_6px_20px_rgba(59,130,246,0.35)] transition-all duration-200 shrink-0">
                          Upgrade
                        </button>
                      </div>
                      <div>
                        ...
                        <button type="button" className="mt-4 h-11 px-4 rounded-lg text-sm font-medium bg-primary text-white shadow-[0_4px_14px_rgba(59,130,246,0.25)] hover:shadow-[0_6px_20px_rgba(59,130,246,0.35)] transition-all duration-200 inline-flex items-center gap-2">
