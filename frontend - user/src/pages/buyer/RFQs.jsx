    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="min-w-0">
          <h1 className="text-2xl font-bold text-slate-900 mb-2 sm:text-3xl">RFQs</h1>
          <p className="text-slate-600">Manage your Request for Quotations</p>
        </div>
        <Link
          to="/send-rfq"
          className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-neutral-900 px-4 py-2.5 font-medium text-white transition-colors hover:bg-neutral-800 sm:w-auto"
        >
