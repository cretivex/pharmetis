...
function Company() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      formData.append('drugLicenseNumber', drugLicenseNumber)
      formData.append('businessType', businessType)
      formData.append('website', website)
      if (file) {
        formData.append('document', file)
      }
      await api.put('/buyer/company', formData, {
    ...
    <div className="p-6 max-w-xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <button
          type="submit"
          disabled={submitting}
          className="w-full py-3 px-6 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 disabled:cursor-not-allowed text-white font-medium rounded-xl transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
        >
