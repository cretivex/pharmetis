    ...
    <div className="pointer-events-auto relative w-full max-w-[17.5rem] overflow-hidden rounded-2xl border border-white/40 bg-gradient-to-b from-white to-slate-50 p-5 shadow-[0_24px_60px_-12px_rgba(15,23,42,0.35)] ring-1 ring-slate-200/90">
      ...
      <div className="relative">
        <div className="flex items-start gap-3">
          <div className="relative flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-brand to-blue-600 text-sm font-bold text-white shadow-lg shadow-brand/35 ring-2 ring-white">
            PM
            <span
        ...
        <button
          type="button"
          className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-brand to-blue-600 py-3 text-sm font-bold text-white shadow-lg shadow-brand/35 transition hover:from-brand-hover hover:to-blue-700"
        >
