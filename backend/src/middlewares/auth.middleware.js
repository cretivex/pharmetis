...
/**
 * Verifies the access JWT. Prefer httpOnly cookie (SPA session); Bearer is a fallback for tooling.
 * Token refresh stays in the client (401 → POST /auth/refresh → retry), not here—avoid silent refresh in middleware.
 */
