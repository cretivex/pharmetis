...
export const loginSchema = Joi.object({
  ...
  /** When set, login succeeds only if the user has this role (e.g. supplier portal sends VENDOR). */
  expectedRole: Joi.string()
    .valid('BUYER', 'VENDOR', 'ADMIN', 'SUPER_ADMIN', 'SUPPORT_ADMIN', 'READ_ONLY_ADMIN')
    .optional()
});
