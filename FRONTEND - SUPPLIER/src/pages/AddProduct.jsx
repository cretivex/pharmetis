...
export default function AddProduct() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Note: supplierId is auto-set by backend for vendors, so we don't include it
      const submitData = {
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2 p-4 rounded-lg border border-blue-300/20 bg-blue-500/10">
                  <Label htmlFor="therapeutics" className="text-base font-semibold text-foreground">
                  ...
                  <Textarea
                    ...
                    rows={4}
                    maxLength={500}
                    className="bg-background/70 border-blue-300/20 text-foreground placeholder:text-muted-foreground"
                  />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="rounded-lg bg-background/70 border-blue-300/20 text-foreground placeholder:text-muted-foreground"
                />
              </div>
              <div className="space-y-2">
                ...
                {imageUrls.map((url, index) => (
                  <div key={index} className="flex gap-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => handleImageFileUpload(index, e.target.files?.[0])}
                    />
                    {uploadingImageIndex === index && <Loader2 className="h-4 w-4 animate-spin self-center" />}
                    {imageUrls.length > 1 && (
                      <Button
                        type="button"
                        variant="outline"
            ...
            {!loadingSupplier && supplier && (
              <Card className="border-indigo-200 bg-indigo-50">
                ...
                <CardContent className="space-y-3">
                  ...
                  {(!supplier.therapeutics || !supplier.manufacturer) && (
                    <div className="pt-2 border-t border-indigo-200">
                      <p className="text-xs text-indigo-700">
                        ...
                        <button
                          ...
                          className="text-indigo-900 font-semibold underline hover:text-indigo-700"
                        >
                          profile
                        </button>
                        {' '}to add therapeutic areas and manufacturer information.
                      </p>
                    </div>
                  )}
                </CardContent>
